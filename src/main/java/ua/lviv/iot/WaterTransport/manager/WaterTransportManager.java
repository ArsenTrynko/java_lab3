...
public class WaterTransportManager implements IWaterTransportManager {
    private List<WaterTransport> waterTransports =new ArrayList<>();


    public final void addTransport(final WaterTransport waterTransport) {
        waterTransports.add(waterTransport);
    }
